...
listman[0].style.fontWeight = "bold";
listman[1].style.fontWeight= "bold";
listman[2].style.fontWeight= "bold";
listman[2].style.backgroundColor = "green";
listman[3].style.fontWeight = "bold";